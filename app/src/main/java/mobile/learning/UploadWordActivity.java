...
public class UploadWordActivity extends AppCompatActivity implements OnPageChangeListener, OnLoadCompleteListener, OnPageErrorListener {
    ...
    private String UPLOAD_URL = Server.URL + "update_word.php";
    private static final String TAG_SUCCESS = "success";
    private static final String TAG_MESSAGE = "message";

    String tag_json_obj = "json_obj_req";

    private static final String TAG = UploadWordActivity.class.getSimpleName();
    @Override
    ...
    private void displayFromFile(File file) {
        ...
        String document = pdfFileName = getFileName(uri);
    ...
    private void uploadFile() {
        if (pdfPath == null) {
            Toast.makeText(this, "please select an word ", Toast.LENGTH_LONG).show();
            return;
        } else {
            showpDialog();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, UPLOAD_URL,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success == 1) {
                                ...
                                Toast.makeText(UploadWordActivity.this, jObj.getString(TAG_MESSAGE), Toast.LENGTH_LONG).show();
                ...
                new com.android.volley.Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        //menampilkan toast
                        Toast.makeText(UploadWordActivity.this, error.getMessage().toString(), Toast.LENGTH_LONG).show();

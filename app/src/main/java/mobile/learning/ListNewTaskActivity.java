...
public class ListNewTaskActivity extends AppCompatActivity implements ListView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_new_task);

        list_view = (ListView) findViewById(R.id.list_view);

        adapter = new AdapterTask(ListNewTaskActivity.this, listData);
    ...
    private void cariData(final String keyword, final String keyword2) {
        ...
        pDialog = new ProgressDialog(ListNewTaskActivity.this);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        String path = ((TextView)view.findViewById(R.id.txt_path)).getText().toString();
        ...
        intent.putExtra(Server.TAG_PATH,path);

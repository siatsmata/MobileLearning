...
public class CheckTaskActivity extends AppCompatActivity implements ListView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new AdapterTask(CheckTaskActivity.this, listData);
    ...
    private void cariData(final String keyword, final String keyword2) {
        ...
        pDialog = new ProgressDialog(CheckTaskActivity.this);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Intent intent = new Intent(this, CheckTaskByNameActivity.class);
